    ...
    if (geometryType == pxWidget.constant.geometryTypeMultiPolygon || geometryType == pxWidget.constant.geometryTypePolygon) {
        ...
        var polygonConfig = {
            ...
            onEachFeature: function (feature, layer) {
                ...
                popupContent += pxWidget.draw.params[id].showTooltipButton ? `<button class="btn btn-primary" onclick="showEdBySa('${feature.properties.ED_GUID}','${feature.properties.name}', '${value}')">View Small Area Map</button>` : '';
                popupContent += "</div>";
